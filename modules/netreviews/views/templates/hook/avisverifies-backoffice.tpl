...
*  @version   Release: $Revision: 7.7.2
*  @license   NetReviews
*  @date      05/12/2018
...
<link rel="stylesheet" href="{$base_url|escape:'htmlall':'UTF-8'}modules/netreviews/views/css/avisverifies-admin.css" >
{/if}
{if $version_ps < 1.6}
<div class="bootstrap">
{/if}
<div class="av_backoffice_top">
    <div class="row netreviews_bo_wrapper">
        <div class="col-xs-12">
            <a href="#"  data-toggle="tooltip" title="{l s='Module Version' mod='netreviews'} {$version|escape:'htmlall':'UTF-8'}">
                <img class="av_display_center av_logo" alt="" src="{$av_path|escape:'htmlall':'UTF-8'}views/img/{l s='logo_full_en.png' mod='netreviews'}"/>
            </a>
        </div>
        <div class="nv_contents" >
            <div class="col-xs-12">
                <div class="av_description">
                <h1>{l s='Use the voice of your customers and boost your sales !' mod='netreviews'}</h1>
                <p>{l s='Verified Reviews is a trusted third party specialized in the collect of seller and product reviews, the control and publication of those.' mod='netreviews'}
                {l s='Measure your shopper satisfaction and improve the customer experience.' mod='netreviews'}
                {l s='Finally, offer a better visibility to your brand by showing product reviews and influence the choice of your customers consequently.' mod='netreviews'}</p>
                <!-- <p>
                    <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/NFS_Avis-en-ligne.png" width="40" alt=""> {l s='Our services are approved by AFNOR certification' mod='netreviews'}
                </p> -->
                </div>
            </div>
        </div>
...
<div class="av_backoffice_pictos">
    <div class="av_picto_elmt">
        <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/picto-collecte-multicanal.png" width="100" alt="">
        <br>
        <label>{l s='Multi-channel review collection' mod='netreviews'}</label>
    </div>
    <div class="av_picto_elmt">
        <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/picto-valortistaion-client.png" width="100" alt="">
        <br>
        <label>{l s='Customer relationship management' mod='netreviews'}</label>
    </div>
    <div class="av_picto_elmt">
        <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/picto-mesure-analyse.png" width="100" alt="">
        <br>
        <label>{l s='Customer experience analysis' mod='netreviews'}</label>
    </div>
    <div class="av_picto_elmt">
        <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/picto-diffusion.png" width="100" alt="">
        <br>
        <label>{l s='Customer reviews showcasing' mod='netreviews'}</label>
    </div>
    <div class="av_picto_elmt">
        <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/picto-engagement-equipes.png" width="100" alt="">
        <br>
        <label>{l s='Team commitment & strategy' mod='netreviews'}</label>
    </div>
</div>

<div class="av_backoffice_bot">
    <div class="row netreviews_bo_wrapper">
        <div  class="col-xs-12">
            <a href="{l s='url_avisverifies_track' mod='netreviews'}" target="_blank" rel="nofollow noreferrer noopener">
                {l s='Start now' mod='netreviews'}
            </a>
            <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/prestashop_partner_logo_transparent_small.png" width="100" alt="">
            ...
            <div class="av_partners">
                <p>{l s='In partnership with' mod='netreviews'} :</p>
                <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/prestashop_partner_logo_google.png" width="100" alt="partner_google">
                <img src="{$av_path|escape:'htmlall':'UTF-8'}views/img/prestashop_partner_logo_bing.png" width="100" alt="partner_bing">
    ...
    <div class="panel col-lg-12">
        ...
        <div class='config panel-body' >
            ...
            <p class="alert alert-info">{l s='Attention : It is obligatory to register first on' mod='netreviews'} <a href="{l s='url_avisverifies_track' mod='netreviews'}" target="_blank" rel="nofollow noreferrer noopener">{l s='www.verified-reviews.com' mod='netreviews'}</a>
             {l s='to start your free trial period' mod='netreviews'}.
            {l s='Please check your' mod='netreviews'} <a href="{l s='url_avisverifies_track' mod='netreviews'}" target="_blank" rel="nofollow noreferrer noopener">{l s='customer area on verified-reviews.com' mod='netreviews'}</a> {l s='to see your login data' mod='netreviews'}</p>
                        ...
                        <div class="row {if $current_multilingue_checked  != 'checked'} hidden {/if} configuration_labels" id="av_multilanguage_configuration">
                            ...
                            <div class="form-group col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-9 col-sm-8 col-xs-12">
                                    ...
                                    <input type="text" name="avisverifies_clesecrete_{$lang.iso_code|escape:'htmlall':'UTF-8'}" id="avisverifies_clesecrete_{$lang.iso_code|escape:'htmlall':'UTF-8'}" value="{$current_avisverifies_clesecrete[$lang.iso_code]|escape:'htmlall':'UTF-8'}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-9 col-sm-8 col-xs-12">
                                    <div class="form-group col-lg-10 col-sm-12 col-xs-12">
                                    <input type="text" name="avisverifies_idwebsite_{$lang.iso_code|escape:'htmlall':'UTF-8'}" id="avisverifies_idwebsite_{$lang.iso_code|escape:'htmlall':'UTF-8'}" value="{$current_avisverifies_idwebsite[$lang.iso_code]|escape:'htmlall':'UTF-8'}"/>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <!-- multilanguage configurations START-->
                    ...
                    <div class="col-lg-9 col-sm-8 col-xs-12">
                        <span class="switch prestashop-switch fixed-width-lg avisverifies_multilingue">
                            ...
                            <input type="radio" name="avisverifies_multilingue" id="avisverifies_multilingue_off" value="0" {if ($current_multilingue_checked eq "0" or !$current_multilingue_checked)} checked="checked"{/if}>
                    ...
                    <div class="radio">
                        ...
                        <!-- {l s='Product reviews widget (classic design)' mod='netreviews'} -->
                            <div class="av_product_award">
                                ...
                                <div id="bottom" {if ($stars_image != 1 && $version_ps >= 1.4 )}style="background:#{$customized_star_color|escape:'htmlall':'UTF-8'}"{/if}><p id ="AV_button">{l s='See the reviews' mod='netreviews'}</p></div>
...
<!-- if display font stars -->
             <div class="form-group {if ($stars_image == 1 || $version_ps < 1.4 )}hidden{/if}">
                ...
                <label class="control-label col-lg-9 col-sm-8 col-xs-12">
                    <span class="col-lg-2 col-sm-4 col-xs-4">
            ...
            <div class="form-group">
                ...
                <label class="control-label col-lg-9 col-sm-8 col-xs-12">
                    <span class="col-lg-2 col-sm-4 col-xs-4">
                        <input type="number" class="numbersOnly form-control"  min="1" name="avisverifies_nb_reviews" id="avisverifies_nb_reviews" value="{if $avisverifies_nb_reviews}{$avisverifies_nb_reviews|escape:'htmlall':'UTF-8'}{else}20{/if}" />
                    </span>
                 <div class="col-lg-6">
        ...
        <!-- display light version tab_content -->
        <div class="form-group">
                <label class="col-lg-3 col-sm-4 col-xs-12 control-label"><span class="label-tooltip" data-toggle="tooltip" data-html="true" title="{l s='See an example' mod='netreviews'}" data-original-title=""><a href="javascript:exampleimage_show();"><b>{l s='Switch reviews display to light version' mod='netreviews'}</b></a></span></label>
            ...
            <!-- display/hide helpful -->
            <div class="form-group">
                <label class="col-lg-3 col-sm-4 col-xs-12 control-label"><span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title=""><b>{l s='Display "helpful reviews"' mod='netreviews'}</b></span></label>
                <div class="col-lg-3 col-sm-8 col-xs-12">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="avisverifies_hidehelpful" id="avisverifies_hidehelpful_on" value="0"{if ($current_hidehelpful_checked eq "0"  or !$current_hidehelpful_checked)} checked="checked"{/if}>
                        <label for="avisverifies_hidehelpful_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='netreviews'}
                        </label>
                        <input type="radio" name="avisverifies_hidehelpful" id="avisverifies_hidehelpful_off" value="1"{if ($current_hidehelpful_checked eq "1")} checked="checked"{/if}>
            ...
            <!-- display/hide media display -->
            <div class="form-group">
                <label class="col-lg-3 col-sm-4 col-xs-12 control-label"><span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title=""><b>{l s='Display media files in review comments (photos)' mod='netreviews'}</b></span></label>
                <div class="col-lg-3 col-sm-8 col-xs-12">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="avisverifies_hidemedia" id="avisverifies_hidemedia_on" value="0"{if ($current_hidemedia_checked eq "0" or !$current_hidemedia_checked)} checked="checked"{/if}>
                        <label for="avisverifies_hidemedia_on" class="radioCheck">
                            <i class="color_success"></i> {l s='Yes' mod='netreviews'}
                        </label>
                        <input type="radio" name="avisverifies_hidemedia" id="avisverifies_hidemedia_off" value="1"{if ($current_hidemedia_checked eq "1")} checked="checked"{/if}>
      ...
      <div class="panel col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9 col-sm-8 col-xs-12">
                        <span class="switch prestashop-switch fixed-width-lg avisverifies_richsnippets">
                            <input type="radio" name="netreviews_snippets_site" id="current_snippets_site_checked_on" value="1"{if (!$current_snippets_site_checked || $current_snippets_site_checked eq "1")} checked="checked"{/if}>
                            <label for="current_snippets_site_checked_on" class="radioCheck">
                                <i class="color_success"></i> {l s='Yes' mod='netreviews'}
                            </label>
                            <input type="radio" name="netreviews_snippets_site" id="current_snippets_site_checked_off" value="0"{if ($current_snippets_site_checked eq "0")}checked="checked"{/if}>
                ...
                <div id="rich_snippets_bo_av" {if ($current_snippets_site_checked eq "0")}class="hidden"{/if}>
                    <div class="form-group">
                        <label class="col-lg-3 col-sm-4 col-xs-12 control-label"><b>{l s='Choose the format of Rich Snippets' mod='netreviews'}</b></label>
                        <div class="col-lg-9 col-sm-8 col-xs-12">
                            <span class="avisverifies_richsnippets_types">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="netreviews_snippets_website_global" id="current_snippets_website_global_checked_1" value="1" {if (!$current_snippets_website_global_checked || $current_snippets_website_global_checked eq '1')} checked="checked" {/if}>
                                        Microdata
                                    </label>
                                </div>
                                <div class="radio">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 col-sm-4 col-xs-12 control-label"><span><b>{l s='My theme already includes Rich Snippets' mod='netreviews'}</b></span></label>
                        <div class="col-lg-9 col-sm-8 col-xs-12">
                            <span class="switch prestashop-switch fixed-width-lg">
                                <input type="radio" name="avisverifies_checkRichSnippetsWebsite_show" id="avisverifies_checkRichSnippetsWebsite_show_on" value="1" {if ($richSnippetsWebsite_checked == 1)} checked="checked"{/if}>
                                <label for="avisverifies_checkRichSnippetsWebsite_show_on" class="radioCheck">
                                    <i class="color_success"></i> {l s='Yes' mod='netreviews'}
                                </label>
                                <input type="radio" name="avisverifies_checkRichSnippetsWebsite_show" id="avisverifies_checkRichSnippetsWebsite_show_off" value="0" {if ( $richSnippetsWebsite_checked == 0  || $richSnippetsWebsite_checked == "" )} checked="checked"{/if}>
                                <label for="avisverifies_checkRichSnippetsWebsite_show_off" class="radioCheck">
                                    <i class="color_danger"></i> {l s='No' mod='netreviews'}
                                </label>
                                <a class="slide-button btn"></a>
                            </span>
    ...
    <div class="panel col-lg-12 debugelement_last">
        ...
        <div id="collapse1" class="panel-collapse collapse">
            <div class="panel-body">
                <fieldset class="form-group row">
                    ...
                    <hr />
                        ...
                        <!-- display tags -->
                <div class="form-group">
                    <label class="control-label col-lg-4 col-sm-6 col-xs-12"><span><b>{l s='Display the tag' mod='netreviews'} (x {l s='reviews' mod='netreviews'})</b></span></label>
                    <div class="col-lg-8 col-sm-6 col-xs-12">
                        <span class="switch prestashop-switch fixed-width-lg">
                            <input type="radio" name="avisverifies_tab_show" id="avisverifies_tab_show_on" value="1" {if ($tabshow_checked == 1 || $tabshow_checked == "" )} checked="checked"{/if}>
                            <label for="avisverifies_tab_show_on" class="radioCheck">
                                <i class="color_success"></i> {l s='Yes' mod='netreviews'}
                            </label>
                            <input type="radio" name="avisverifies_tab_show" id="avisverifies_tab_show_off" value="0" {if ( $tabshow_checked == 0)} checked="checked"{/if}>
            ...
            {/if}
                ...
                <div class="form-group">
                    <label class="control-label col-lg-4 col-sm-6 col-xs-12"><span><b>{l s='Display stars on the homepage' mod='netreviews'}</b></span></label>
                    <div class="col-lg-8 col-sm-6 col-xs-12">
                        <span class="switch prestashop-switch fixed-width-lg">
                            <input type="radio" name="avisverifies_starshome_show" id="avisverifies_starshome_show_on" value="1" {if ($starshome_checked == 1)} checked="checked"{/if}>
                            <label for="avisverifies_starshome_show_on" class="radioCheck">
                                <i class="color_success"></i> {l s='Yes' mod='netreviews'}
                            </label>
                            <input type="radio" name="avisverifies_starshome_show" id="avisverifies_starshome_show_off" value="0" {if ( $starshome_checked == 0  || $starshome_checked == "" )} checked="checked"{/if}>
            ...
            <hr />
                        ...
                        <label class="control-label col-lg-8 col-sm-5 col-xs-12">
                            <span class="col-lg-2 col-sm-4 col-xs-4">
                            <input type="number" class="form-control numbersOnly" min="0" name="avisverifies_nb_products" id="avisverifies_nb_products" value="{if $avisverifies_nb_products}{$avisverifies_nb_products|escape:'htmlall':'UTF-8'}{else}{/if}" />
                            </span>
                        </label>
                        </div>
                        ...
                        <label class="control-label col-lg-8 col-sm-5 col-xs-12">
                            <span class="col-lg-2 col-sm-4 col-xs-4">
                            <input type="number" class="form-control numbersOnly" min="0" step="any" name="avisverifies_amount_min_products" id="avisverifies_amount_min_products" value="{if $avisverifies_amount_min_products}{$avisverifies_amount_min_products|escape:'htmlall':'UTF-8'}{else}{/if}" />
                            </span>
                        ...
                        <ul class="list-group col-lg-3 col-sm-6 col-xs-12 pull-right">
                            ...
                            <li class="list-group-item">Hook list :
                                {foreach from=$hook_list key=numberofhook item=hooktable}
                                    <div>{$numberofhook|escape:'htmlall':'UTF-8'} - {$hooktable.name|escape:'htmlall':'UTF-8'}</div>
                                {/foreach}
                                {if $version_ps > 1.5}
                                    <div class="col-lg-8 col-sm-5 col-xs-12">
                                        <input type="submit"  name="submit_addhooklist" id="submit_addhooklist" value="{l s='add all hooks' mod='netreviews'}" class="btn btn-danger">
                                    </div>
                                {/if}
                            </li>
                        </ul>
...
{literal}
    <script language=javascript>
        ...
        $(".avisverifies_richsnippets").change(function(){
            $("#rich_snippets_bo_av").toggleClass("hidden");
        })

        $(".avisverifies_multilingue").change(function(){
            $("#av_configuration").toggleClass("hidden");
            $("#av_multilanguage_configuration").toggleClass("hidden");
        })
        function cocheToute(){
