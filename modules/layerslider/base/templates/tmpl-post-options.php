    ...
    <div class="ls-box ls-modal ls-configure-posts-modal">
        ...
        <div class="ls-post-advanced">
            ...
            <h3 class="subheader clearfix">
                <div class="half"><?php ls_e('Order results by', 'LayerSlider') ?></div>
                <div class="half">
                    <div class="half"><?php ls_e('Image size', 'LayerSlider') ?></div>
                    <div class="half"><?php ls_e('On this slide', 'LayerSlider') ?></div>
                </div>
            </h3>
            <div class="ls-post-adv-settings clearfix">
                ...
                <div class="half" style="padding:0">
                    <div class="half">
                        <!-- Taxonomy terms -->
                        <?php lsGetSelect($lsDefaults['slider']['postTaxTerms'], $slider['properties'], array('data-param' => $lsDefaults['slider']['postTaxTerms']['keys'])) ?>
                    </div>
                    <div class="half">
                        <!-- Post offset -->
