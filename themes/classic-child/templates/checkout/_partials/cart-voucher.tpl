    ...
    {block name='cart_voucher'}
        <div class="block-promo">
            <div class="cart-voucher">
                ...
                <span class="promoadd">{l s='Code Promo' d='Shop.Theme.Checkout'} </span>
                    <a class="collapse-button" href="#promo-code">     <span class="codpromo"> {l s='Ajouter' d='Shop.Theme.Checkout'}  </span>
                ...
                <div id="promo-code" class="collapse{if $cart.discounts|count > 0} in{/if}">
                    <div class="promo-code">
                        ...
                        <a class="collapse-button promo-code-button cancel-promo" role="button" data-toggle="collapse"
